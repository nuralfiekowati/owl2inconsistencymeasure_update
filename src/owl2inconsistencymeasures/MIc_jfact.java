...
class MIc_jfact {
	...
	public static void MIc_measure(Set<OWLAxiom> arrayOfExplanation, Set<Explanation<OWLAxiom>> explanations) {

		long startTime = System.currentTimeMillis();

		try {
			File file = new File("outputs/output_jfact_MIc_K3.txt");
